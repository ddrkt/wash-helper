...
namespace AForge.WindowsForms
{
    ...
    public class Sample
    {
        ...
        public Sample(double[] inputValues, int classesCount, SignType sampleClass = SignType.Undefined)
        {
            //  Клонируем массивчик
            input = (double[])inputValues.Clone();
            output = new double[classesCount];
            if (sampleClass != SignType.Undefined) output[(int)sampleClass] = 1;


            recognizedClass = SignType.Undefined;
